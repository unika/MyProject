	...
	<div class="fixed_big_from">
		<div class="fixed_from user_left">
			...
			<ul class="fixed_content">
				...
				<li>
					<a target="_top" href="__URL__/myorder">My Order</a>
				</li>
				<li>
			...
			<form id="UserForm" action="__URL__/UpdateInfo" method="post">
				<div class="fixed_content">
					...
					<div class="fixed_middle">
						...
						<ul>
							<li>
								<input class="fixed_text2" name="firstName" value="<?php echo ($firstName); ?>" type="text">
							</li>
							<li>
								<input class="fixed_text2" name="secondName" value="<?php echo ($secondName); ?>" type="text">
							</li>
							<li>
							...
							<li>
								<input class="fixed_text2" name="city" value="<?php echo ($city); ?>" type="text">
							</li>

							<li>
								<input class="fixed_text2" name="address" value="<?php echo ($address); ?>" style="width:258px;" type="text">
							</li>

							<li>
								<input class="fixed_text2" name="tel" value="<?php echo ($tel); ?>" type="text">
							</li>
							<li>
								<input class="fixed_text2" name="postCode" value="<?php echo ($postCode); ?>" type="text">
							</li>
							<li>
								<input class="fixed_text2" name="email" value="<?php echo ($email); ?>" type="text">
							</li>
						</ul>
						<div class="clear"></div>
					</div>
